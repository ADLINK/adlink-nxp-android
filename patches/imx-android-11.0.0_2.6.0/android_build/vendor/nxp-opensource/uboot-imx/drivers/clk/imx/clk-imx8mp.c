...
static const char *imx8mp_pcie_aux_sels[] = {"clock-osc-24m", "sys_pll2_200m", "sys_pll2_50m",
					     "sys_pll3_out", "sys_pll2_100m", "sys_pll1_80m",
					     "sys_pll1_160m", "sys_pll1_200m", };

static const char *imx8mp_pcie2_ctrl_sels[] = {"clock-osc-24m", "sys_pll2_250m", "sys_pll2_200m",
					       "sys_pll1_266m", "sys_pll1_800m", "sys_pll2_500m",
					       "sys_pll2_333m", "sys_pll3_out", };

static const char *imx8mp_pcie2_phy_sels[] = {"clock-osc-24m", "sys_pll2_100m", "sys_pll2_500m",
					      "clk_ext1", "clk_ext2", "clk_ext3",
...
static int imx8mp_clk_probe(struct udevice *dev)
{
	...
	clk_dm(IMX8MP_CLK_PCIE2_CTRL, imx8m_clk_composite("pcie2_ctrl", imx8mp_pcie2_ctrl_sels, base + 0xc000));
	clk_dm(IMX8MP_CLK_PCIE2_PHY, imx8m_clk_composite("pcie2_phy", imx8mp_pcie2_phy_sels, base + 0xc080));
	...
	clk_dm(IMX8MP_CLK_HSIO_AXI_SRC, imx8m_clk_composite("hsio_axi_src", imx8mp_hsio_axi_sels, base + 0x8380));
        clk_dm(IMX8MP_CLK_HSIO_AXI_CG, imx_clk_gate3("hsio_axi_cg", "hsio_axi_src", base + 0x8380, 28));
	clk_dm(IMX8MP_CLK_HSIO_AXI_DIV, imx_clk_divider2("hsio_axi_div", "hsio_axi_cg", base + 0x8380, 0, 3));
